...
// End Cross Module References
	...
	struct Z_Construct_UClass_AEnemyShip_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_EnemyMap_ValueProp;
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_EnemyMap_Key_KeyProp;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EnemyMap_MetaData[];
#endif
		static const UE4CodeGen_Private::FMapPropertyParams NewProp_EnemyMap;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_ValueProp = { "EnemyMap", nullptr, (EPropertyFlags)0x0000000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_Key_KeyProp = { "EnemyMap_Key", nullptr, (EPropertyFlags)0x0000000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_MetaData[] = {
		{ "Category", "EnemyShip" },
		{ "ModuleRelativePath", "EnemyShip.h" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap = { "EnemyMap", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemyShip, EnemyMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemyShip_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemyShip_Statics::NewProp_EnemyMap,
	};
	...
	IMPLEMENT_CLASS(AEnemyShip, 636076142);
